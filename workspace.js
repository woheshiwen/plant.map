(() => {
  ...
  const I18N = {
    zh: {
      ...
      headline: '你现在要做什么种植图？',
      lead: '自主的种植概念工作台：先建项目，再选模块。从底图分区到图板导出，AI 能力会按卡片逐步接入。',
      allTools: '全部工具',
      modalTitle: '新建项目',
      nameLabel: '项目名称',
      typeLabel: '项目类型',
    ...
    en: {
      ...
      lead: 'An original planting workspace: create a project first, then pick a module. From base plans to board export — AI tools will land card by card.',
      allTools: 'All tools',
